...
function displayIssues(issuesList) {
    ...
    issuesList.forEach(issue => {
        // 1. Generate the Label Badges HTML first
        ...
        card.className = "card bg-white border-t-4 border-violet-500 shadow-sm border-x border-b rounded-lg hover:shadow-md transition-shadow";
